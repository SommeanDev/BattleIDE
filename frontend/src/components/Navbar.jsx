    ...
    <header className="flex w-full justify-between fixed bg-transparent z-50 p-4">
      ...
      <SignedIn>
        <div className="flex gap-2">
          <div className="bg-gradient-to-r from-black/60 to-white/5 text-white font-semibold backdrop-blur-lg flex justify-center items-center px-4 rounded-4xl border-2 border-l-0 border-b-1 border-white/30 filter">
            ACE I
          </div>
